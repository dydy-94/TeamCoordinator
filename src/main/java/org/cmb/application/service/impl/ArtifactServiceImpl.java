...
public class ArtifactServiceImpl implements ArtifactService {
    ...
    public ArtifactView complete(
        ...
        ArtifactDO artifact = require(identity, projectId, artifactId);
    ...
    public String registerExpertArtifact(
            DispatchWorkDO work, TaskDO task, String storageKey) {
        MockFileDescriptor descriptor = fileStore.getDescriptor(storageKey);
    ...
    private ArtifactView toView(ArtifactDO artifact, boolean includeDownload) {
