...
public class ProjectServiceImpl implements ProjectService {
    ...
    public ProjectView update(
        ...
        ProjectDO project = requireOwnerAndActive(identity, projectId);
     ...
     */
    private void requireBuiltInAgentCore(ProjectDO project) {
    ...
    @Transactional(readOnly = true)
    public List<SkillDO> listProjectSkills(RequestIdentity identity, String projectId) {
        ProjectDO project = requireVisible(identity, projectId);
    ...
    public ProjectView upsertSkill(
        ...
        SkillDO skill = skillRepository.findByBusinessId(request.getSkillId());
        if (skill == null) {
    ...
    private ProjectView toView(ProjectDO project) {
        ProjectView view = new ProjectView();
        view.setId(project.getId());
        view.setName(project.getName());
        view.setDescription(project.getDescription());
