...
ALTER TABLE digital_team_coordinator_cli_submission RENAME COLUMN session_id TO task_id;

DROP INDEX idx_cli_submission_session;
CREATE INDEX idx_cli_submission_task ON digital_team_coordinator_cli_submission (task_id);
